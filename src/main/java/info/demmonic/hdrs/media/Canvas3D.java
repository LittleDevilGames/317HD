...
public class Canvas3D extends Canvas2D {
    ...
    public static void drawFlatTriangle(int a_x, int a_y, int b_x, int b_y, int c_x, int c_y, int rgb) {
        ...
        //A ----- C
        if (a_y <= b_y && a_y <= c_y) {
            if (a_y >= Canvas2D.rightY) {
                return;
            }

            if (b_y > Canvas2D.rightY) {
                b_y = Canvas2D.rightY;
            }

            if (c_y > Canvas2D.rightY) {
                c_y = Canvas2D.rightY;
            }
    ...
    public static void drawShadedTriangle(int x1, int y1, int x2, int y2, int x3, int y3, int hsl1, int hsl2, int hsl3) {
        ...
        if (y1 <= y2 && y1 <= y3) {
            if (y1 >= Canvas2D.rightY) {
                return;
            }

            if (y2 > Canvas2D.rightY) {
                y2 = Canvas2D.rightY;
            }

            if (y3 > Canvas2D.rightY) {
                y3 = Canvas2D.rightY;
            }
    ...
    public static void prepare() {
        ...
        Canvas3D.centerX = Canvas2D.width / 2;
        Canvas3D.centerY = Canvas2D.height / 2;
    }
